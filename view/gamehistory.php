<?php
  ...
  $sql = "SELECT * FROM players join matches on playMatchId = mId join paragraph on mmParId = id where playUserId = ".$_SESSION['user_id']." order by playId desc";
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <?php if ($_SESSION['role'] == 'admin') { ?>
          <li><a href="/typeracer/view/adminPage.php">GAME HISTORY</a></li>
      ...
      <div class="col-md-12">
        ...
        <table class="table table-striped table-hover par-table">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td><?php echo $row['mCreatedOn'] ?></td>
              <td><?php echo $row['playResult'] ?></td>
