...
<html lang="en" dir="ltr">
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <?php if ($_SESSION['role'] == 'admin') { ?>
          ...
          <li><a href="/typeracer/view/user.php">User</a></li>
        <?php }  ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2>PARAGRAPHS</h2>
        <button class="btn btn-success addParagraph" name="button">ADD</button>
        <br><br>
        <table class="table table-striped table-hover par-table">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td class="par-id" id="<?php echo $row['id'] ?>"><?php echo $row['id'] ?></td>
              <td class="par-text"><?php echo $row['paragraph'] ?></td>
              <!-- <button type="btn btn-danger delete">DELETE</button> -->
              <td> <button class="btn btn-danger delete" name="button">DELETE</button> </td>
            </tr>
            <?php
              }
            }
